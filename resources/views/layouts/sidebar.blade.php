    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ request()->is('admin/ambulance-types*') ? 'active' : '' }}">
        <a href="{{ route('admin.ambulance-types.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Ambulance Types">Ambulance Type</div>
        </a>
      </li>
      ...
      <li class="menu-item {{ request()->is('admin/purposes*') ? 'active' : '' }}">
        <a href="{{ route('admin.purposes.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Purposes">Purpose</div>
        </a>
      </li>
      ...
      <li class="menu-item {{ request()->is('admin/additional-services*') ? 'active' : '' }}">
        <a href="{{ route('admin.additional-services.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Additional Services">Additional Service</div>
        </a>
      </li>
      ...
      <li class="menu-item {{ request()->is('admin/destinations*') ? 'active' : '' }}">
        <a href="{{ route('admin.destinations.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Destinations">Destination</div>
        </a>
      </li>
{{-- 
      <li class="menu-item {{ request()->is('backadmin/ticket*') ? 'active open' : '' }}">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons ti ti-checkbox"></i>
          <div data-i18n="Tickets">Tickets</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item {{ request()->is('backadmin/ticket/inquiry*') ? 'active' : '' }}">
            <a href="{{ route('backadmin.ticket.inquiry.index') }}" class="menu-link">
              <div data-i18n="Inquiry">Inquiry</div>
            </a>
          </li>
          <li class="menu-item {{ request()->is('backadmin/ticket/crq*') ? 'active' : '' }}">
            <a href="{{ route('backadmin.ticket.crq.index') }}" class="menu-link">
              <div data-i18n="CRQ">CRQ</div>
            </a>
          </li>
          <li class="menu-item {{ request()->is('backadmin/ticket/srm*') ? 'active' : '' }}">
            <a href="{{ route('backadmin.ticket.srm.index') }}" class="menu-link">
              <div data-i18n="SRM">SRM</div>
            </a>
          </li>
          <li class="menu-item {{ request()->is('backadmin/ticket/request-activity-crq*') ? 'active' : '' }}">
            <a href="{{ route('backadmin.ticket.request-activity-crq.index') }}" class="menu-link">
              <div data-i18n="Request Activity">Request Activity</div>
            </a>
          </li>
        </ul>
      </li> --}}
      ...
      <li class="menu-item {{ request()->is('backadmin/inventory') ? 'active' : '' }}">
        <a href="{{ route('backadmin.inventory.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Hardware">Hardware</div>
        </a>
      </li>
  
      <li class="menu-item {{ request()->is('backadmin/regional*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.regional.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Regional">Regional</div>
        </a>
      </li>
  
      <li class="menu-item {{ request()->is('backadmin/inventory-rma*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.inventory-rma.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="RMA">RMA</div>
        </a>
      </li>

      
     <li class="menu-header small text-uppercase">
        <span class="menu-header-text">Report Builder</span>
      </li>
  
      <li class="menu-item {{ request()->is('backadmin/report-builder*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.report-builder.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Report Builder">Report Builder</div>
        </a>
      </li>
      ...
      <li class="menu-item {{ request()->is('backadmin/user*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.user.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-user"></i>
          <div data-i18n="Users">Users</div>
        </a>
      </li>
      <li class="menu-item {{ request()->is('backadmin/domain*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.domain.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-wifi"></i>
          <div data-i18n="Domains">Domains</div>
        </a>
      </li>
  
      <li class="menu-item {{ request()->is('backadmin/category*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.category.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-category-2"></i>
          <div data-i18n="Categories">Categories</div>
        </a>
      </li>
  
      <li class="menu-item {{ request()->is('backadmin/group-source*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.groupSource.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="Channels">Channels</div>
        </a>
      </li>
  
      <li class="menu-item {{ request()->is('backadmin/sop*') ? 'active' : '' }}">
        <a href="{{ route('backadmin.sop.index') }}" class="menu-link">
          <i class="menu-icon tf-icons ti ti-files"></i>
          <div data-i18n="SOP">SOP</div>
        </a>
      </li> --}}
    </ul>
</aside>
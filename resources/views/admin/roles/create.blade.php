...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Admin / Peran /</span> Tambah Peran
    </h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form id="form" action="{{ route('admin.roles.store') }}" method="POST">
                @csrf
                <div class="row">
                ...
                <div class="row">
                    ...
                    @foreach($permissions as $group => $x)
                        <div class="col-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="card-title mb-0">{{ ucfirst(str_replace('-', ' ', $group)) }}</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">

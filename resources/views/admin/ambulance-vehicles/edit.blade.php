...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Edit Kendaraan Ambulance</h5>
        </div>
        <div class="card-body">
            <form id="ambulance-vehicle-form" action="{{ route('admin.ambulance-vehicles.update', $ambulanceVehicle->id) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" 
                            ...
                            id="vehicle_name" 
                            name="vehicle_name" 
                            value="{{ old('vehicle_name', $ambulanceVehicle->vehicle_name) }}" 
